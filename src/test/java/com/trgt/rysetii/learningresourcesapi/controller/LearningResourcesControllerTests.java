package com.trgt.rysetii.learningresourcesapi.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.trgt.rysetii.learningresourcesapi.controllers.LearningResourceController;
...
public class LearningResourcesControllerTests {
    ...
    public void getAllTheAvailableLearningResources() throws Exception {
        ...
        LearningResource learningResource1 = new LearningResource(1311, "Test Name 1",
                100.0, 120.0, LearningResourceStatus.LIVE, LocalDate.now(),
                LocalDate.now().plusMonths(5), LocalDate.now().plusYears(2));

        LearningResource learningResource2 = new LearningResource(1312, "Test Name 2",
                120.0, 180.0, LearningResourceStatus.LIVE, LocalDate.now(),
    ...
    public void deleteTheRequestedLearningResource() throws Exception {
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.delete("/learningresources/v1/learningresource/"
                        + inputLearningResourceId))
                .andExpect(status().isOk());
    }
}
