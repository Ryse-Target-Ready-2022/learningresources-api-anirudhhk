...
public class LearningResourcesServiceTests {
    ...
    public void sortTheLearningResourceBasedOnProfitMarginInNonIncreasingOrder() {
        ...
        assertEquals(learningResources, learningResourcesSorted, "The learning resources are not sorted by" +
                " profit margin");
    }
    ...
    public void saveTheLearningResources() {
        ...
        LearningResource learningResource3 = new LearningResource(1313, "Test Name 3",
                120.0, 180.0, LearningResourceStatus.LIVE, LocalDate.now(),
                LocalDate.now().plusMonths(6), LocalDate.now().plusYears(3));
